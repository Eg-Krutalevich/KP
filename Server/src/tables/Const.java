...
public class Const {
    ...
    public static final String VACANCY_SURNAME = "surname";
    public static final String VACANCY_NAME = "name";

    public static final String VACANCY_POST = "post";
    ...
    public static final String AIRPORT_NAME = "name_airport";
    public static final String AIRPORT_COUNTRY = "country";
    public static final String AIRPORT_CITY = "city";
    public static final String AIRPORT_PLACE = "place";

    public static final String STUFF_TABLE = "stuff";

    public static final String STUFF_ID = "id_stuff";
    public static final String STUFF_STUFF_OBJECT = "stuff_object";
    public static final String STUFF_PUNISHMENT = "punishment";
